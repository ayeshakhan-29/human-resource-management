    ...
    return (
        <div className="container mx-auto py-10 px-4">
            <div className="flex justify-between items-center mb-8">
                ...
                <Button asChild className="bg-blue-600 hover:bg-blue-700 shadow-md transition-all hover:scale-105">
                    <Link href="/employee/leave/apply" className="flex items-center gap-2">
