    ...
    <>
      ...
      <div className="flex flex-1 flex-col gap-6 p-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-gray-600">Browse and manage all tasks across projects</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          ...
          <Card className="bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-yellow-600">Currently being worked on</p>
            </CardContent>
          </Card>
          <Card className="bg-gradient-to-r from-gray-50 to-gray-100 border-gray-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-600">Queued up</p>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Refine the task list</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  {loading ? (
                    ...
                    filtered.map((t) => (
                      ...
                      >
                        ...
                        <TableCell>{statusBadge(t.status as "pending" | "in-progress" | "completed")}</TableCell>
                      </TableRow>
                    ))
                  )}
                </TableBody>
